  ...
  return (
    <div className="text-mainDarkGray grid sm:grid-cols-4 grid-cols-2 gap-2 mt-7">
      {Object.values(CATEGORY).map((category, i) => (
        ...
        >
          <div className="w-full h-full flex flex-col items-center justify-center text-center backdrop-blur-sm backdrop-grayscale backdrop-brightness-110 bg-white bg-opacity-50 hover:bg-white hover:bg-opacity-75">
